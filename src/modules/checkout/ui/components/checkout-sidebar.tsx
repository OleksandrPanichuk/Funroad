        ...
        >
            ...
            <div className={'p-4 flex items-center justify-center'}>
                <Button
                    ...
                    size={'lg'}
                    className={
                        'text-base w-full text-white bg-primary hover:bg-pink-400 hover:text-primary'
                    }
                >
                    Checkout
                </Button>
            ...
            {isCanceled && (
                ...
                >
                    <div
                        className={
                            'bg-red-100 border border-red-400 font-medium px-4 py-3 rounded flex items-center w-full'
                        }
                    >
                        <div className={'flex items-center'}>
                            <CircleXIcon
                                className={
                                    'size-6 mr-2 fill-red-500 text-red-100'
                                }
                            />
